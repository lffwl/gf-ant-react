...
import { Form, Input, Switch, Select, Button, Modal, Row, Col, Image, Tabs, DatePicker } from 'antd';
...
const ArticleEdit: React.FC<ArticleEditProps> = ({ visible, onCancel, onSuccess, editArticle }) => {
