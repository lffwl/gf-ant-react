...
type CategoryCreateReq struct {
	...
	CoverImage     string      `p:"coverImage" description:"栏目封面图片URL"`
...
type CategoryTreeRes struct {
	...
	Config *CategoryTreeResConfig `json:"config"`
}

type CategoryTreeResConfig struct {
	CategoryContentTypeMap map[string]string `json:"categoryContentTypeMap"`
}
